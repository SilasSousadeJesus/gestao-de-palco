...
- O botao "Limpar palco" agora tambem zera o tempo decorrido do evento (o icone de parar um bloco individualmente nao zera). O layout do console de gestao mudou: preview ao vivo passou a ocupar uma linha propria em largura total, abaixo dos 3 cards do topo (Eventos, Evento Aberto e um terceiro card). Evidencia em `.sdd/features/2026-09-01-reset-tempo-e-layout-preview/RECORD.md`.
...
- Os cards "Eventos", "Evento Aberto" e "Relatorio de Blocos" tem altura fixa de 416.8px e nao crescem mais com o conteudo; listas e tabela rolam internamente quando excedem o espaco. Botoes de mensagem ficaram mais curtos ("Temporaria"/"Permanente"/"Limpar", com `title` explicando cada um) para caberem numa linha so. Evidencia em `.sdd/features/2026-09-01-altura-fixa-cards/RECORD.md`.
