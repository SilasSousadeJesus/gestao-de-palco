...
- O botao "Limpar palco" agora tambem zera o tempo decorrido do evento (o icone de parar um bloco individualmente nao zera). Mora hoje no card "Preview ao vivo", logo abaixo da caixa de preview (nao mais em "Evento Aberto"). Evidencia em `.sdd/features/2026-09-01-reset-tempo-e-layout-preview/RECORD.md` e `.sdd/features/2026-09-01-preview-overflow-e-limpar-palco/RECORD.md`.
