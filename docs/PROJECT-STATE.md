...
- O card "Em breve" virou "Relatorio de blocos": tabela Nome/Tempo/Atraso por bloco, atualizada ao vivo, com atraso em vermelho quando o bloco estoura o tempo planejado (ex.: 30 min planejado, 35 usado = "-5 min"). Exige a nova coluna `time_blocks.actual_seconds` (migration `0004`). "Limpar palco" zera a tabela junto com o tempo decorrido. Console de gestao ganhou tambem "Horario atual" (hh:mm:ss ao vivo) acima de "Total Planejado". Evidencia em `.sdd/features/2026-09-01-relatorio-blocos-atraso/RECORD.md` e `.sdd/features/2026-09-01-horario-atual/RECORD.md`.
