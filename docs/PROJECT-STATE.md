...
- O botao "Limpar palco" agora tambem zera o tempo decorrido do evento (o icone de parar um bloco individualmente nao zera). Evidencia em `.sdd/features/2026-09-01-reset-tempo-e-layout-preview/RECORD.md`.
